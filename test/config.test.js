...
test("default config keeps cls target but disables upload during development", () => {
  assert.equal(DEFAULT_CONFIG.uploadEnabled, false);
  ...
  assert.equal(hasUploadTarget(DEFAULT_CONFIG), false);
});
